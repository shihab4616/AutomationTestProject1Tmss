...
public class POMIS_2 extends Login {
	...
	public static void TC_POMIS2_001() {
		...
		WebElement POMIS2= driver.findElement(By.linkText("1.2 PKSF POMIS-2 Report"));
		POMIS2.click(); 
		...
		WebElement Show=driver.findElement(By.xpath("/html/body/section/div/div/div/section/div[2]/div/div/div[1]/div/div/table/tbody/tr/td[9]/button"));
		Show.click(); 
